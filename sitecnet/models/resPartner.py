...
class resPartner(models.Model):
    ...
    servicios = fields.One2many('sitecnet.servicios', 'empresa', string='Servicios contratados', copy=True, auto_join=True, select=True, domain=[('is_company', '=', True)])# if company is true
