...
class resPartner(models.Model):
    ...
    director = fields.Many2one('res.partner', string='Director')# if company is true
    contacto = fields.Many2one('res.partner', string='Contacto principal')# if company is true
    servicios = fields.One2many('sitecnet.servicios', 'empresa', string='Servicios contratados', copy=True, auto_join=True)# if company is true
